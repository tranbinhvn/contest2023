...
def setupConfiguration_of_sensing_gui(testo):
    ...
    adc_config.sample_time = lib.RADAR_ADC_SAMPLETIME_100NS
    adc_config.tracking = lib.RADAR_ADCTRK_1_SUBCONVERSIONS
    ...
    frame_configuration.shapes[0].post_delay_100ps = 1744875
    frame_configuration.shapes[1].num_repetitions = 2
    frame_configuration.shapes[1].following_power_mode = lib.EP_RADAR_BGT60TRXX_POW_STAY_ACTIVE
    frame_configuration.shapes[1].post_delay_100ps = 628625
    frame_configuration.shapes[2].num_repetitions = 0
    frame_configuration.shapes[2].following_power_mode = lib.EP_RADAR_BGT60TRXX_POW_STAY_ACTIVE
    frame_configuration.shapes[2].post_delay_100ps = 125
    frame_configuration.shapes[3].num_repetitions = 0
    frame_configuration.shapes[3].following_power_mode = lib.EP_RADAR_BGT60TRXX_POW_STAY_ACTIVE
    frame_configuration.shapes[3].post_delay_100ps = 125
    frame_configuration.shape_set.num_repetitions = 4
    frame_configuration.shape_set.following_power_mode = lib.EP_RADAR_BGT60TRXX_POW_GO_IDLE
    frame_configuration.shape_set.post_delay_100ps = 1171458000
    ...
    try:
        testo.communication.RadarBGT6x.set_tx_mode(lib.EP_RADAR_MODE_TX_ONLY_TX1)
        print("configuration on this EP is done OK.: RadarBGT6x")
    except:
        print("configuration on this EP NOT done : RadarBGT6x")
    ...
    try:
        testo.communication.RadarBGT60TRxx.set_chirp_end_delay(35625)
        print("configuration on this EP is done OK.: RadarBGT60TRxx")
    except:
        print("configuration on this EP NOT done : RadarBGT60TRxx")
    ...
    baseband_configuration.hp_gain_1 = lib.EP_RADAR_BGT6X_HP_GAIN_18DB
    baseband_configuration.hp_cutoff_1 = lib.EP_RADAR_BGT6X_HP_CUTOFF_80KHZ
    baseband_configuration.vga_gain_1 = lib.EP_RADAR_BGT6X_VGA_GAIN_5DB
    baseband_configuration.hp_gain_2 = lib.EP_RADAR_BGT6X_HP_GAIN_18DB
    baseband_configuration.hp_cutoff_2 = lib.EP_RADAR_BGT6X_HP_CUTOFF_80KHZ
    baseband_configuration.vga_gain_2 = lib.EP_RADAR_BGT6X_VGA_GAIN_5DB
    baseband_configuration.hp_gain_3 = lib.EP_RADAR_BGT6X_HP_GAIN_18DB
    baseband_configuration.hp_cutoff_3 = lib.EP_RADAR_BGT6X_HP_CUTOFF_80KHZ
    baseband_configuration.vga_gain_3 = lib.EP_RADAR_BGT6X_VGA_GAIN_5DB
    baseband_configuration.hp_gain_4 = lib.EP_RADAR_BGT6X_HP_GAIN_18DB
    baseband_configuration.hp_cutoff_4 = lib.EP_RADAR_BGT6X_HP_CUTOFF_80KHZ
    baseband_configuration.vga_gain_4 = lib.EP_RADAR_BGT6X_VGA_GAIN_5DB
    baseband_configuration.reset_timer_period_100ps = 5000
    try:
    ...
    #  /* configure additional delay at end of chirp */
    try:
        testo.communication.RadarBGT60TRxx.set_chirp_end_delay(250)
        print("configuration on this EP is done OK.: RadarBGT60TRxx")
    except:
        print("configuration on this EP NOT done : RadarBGT60TRxx")
